...
exports.CampaignModule = CampaignModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [campaign_service_1.CampaignService, mail_sender_service_1.MailSenderService],
        exports: [campaign_service_1.CampaignService, mail_sender_service_1.MailSenderService],
    })
], CampaignModule);
