...
exports.ValidatorModule = ValidatorModule = __decorate([
    (0, common_1.Module)({
        providers: [email_validator_service_1.EmailValidatorService, validator_service_1.ValidatorService],
        exports: [email_validator_service_1.EmailValidatorService, validator_service_1.ValidatorService],
    })
], ValidatorModule);
